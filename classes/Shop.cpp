...
bool Shop::shopOpen(sf::RenderWindow* window, int money)
{
    ...
    displayShopText(window, "2 р.", priceX, itemStartY + itemStep * 0, 36, sf::Color::Black);

    displayShopText(window, "2. Купить семена ячменя", labelX, itemStartY + itemStep * 1, 36, sf::Color::Black);
    displayShopText(window, "3 р.", priceX, itemStartY + itemStep * 1, 36, sf::Color::Black);

    displayShopText(window, "3. Купить курицу", labelX, itemStartY + itemStep * 2, 36, sf::Color::Black);
    displayShopText(window, "15 р.", priceX, itemStartY + itemStep * 2, 36, sf::Color::Black);
    ...
    displayShopText(window, "1 р.", priceX, itemStartY + itemStep * 4, 36, sf::Color::Black);

    displayShopText(window, "6. Купить удобрения", labelX, itemStartY + itemStep * 5, 36, sf::Color::Black);
    displayShopText(window, "2 р.", priceX, itemStartY + itemStep * 5, 36, sf::Color::Black);
